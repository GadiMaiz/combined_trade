...
class BitfinexWSS(WSSAPI):
        ...
        while self.running:
            if self._receiver_lock.acquire(blocking=False):
                try:
                    ...
                    self._receiver_lock.release()
                    continue
                except (WebSocketConnectionClosedException, ssl.SSLError):
    ...
    def handle_response(self, ts, resp):
        ...
        # Handle Non-Critical Errors
            ...
            log.exception(e)
            print(e)
        except (GenericSubscriptionError, TypeError) as e:
            log.exception(e)
            print(e)
    ...
    def _handle_pong(self, ts, *args, **kwargs):
        ...
        try:
            ...
            log.error("BitfinexWSS.ping(): Error (%ss)",
                     str(e))
        self.ping_timer = None
