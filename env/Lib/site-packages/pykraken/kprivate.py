...
def kprivate_addorder(client, pair=None, typeo=None, ordertype=None, price=None, price2=None, volume=None,
    ...
    params = {}
    params['trading_agreement'] = 'agree' # Added according to https://support.kraken.com/hc/en-us/articles/360000920026-Trading-Agreement-required-for-orders-sent-via-API
    if pair:
        params['pair'] = pair
    else:
